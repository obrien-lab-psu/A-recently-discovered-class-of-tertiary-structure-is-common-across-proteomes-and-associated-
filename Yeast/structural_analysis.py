...
logging.basicConfig(filename="yeast_structural_analysis.log", format="%(asctime)s %(message)s", filemode="w")
...
def null_dist_p_val_calc(uniprot: str):
    ...
    if ent_res is not None:
        ...
        with open(f"DATA/yeast_mc_pvals_stochastic_full/{uniprot}-PW-Pval.json", "w") as js:
...
if __name__ == "__main__":
    ...
    # directories = {"DATA/yeast_mc_pvals_stochastic_full"}
