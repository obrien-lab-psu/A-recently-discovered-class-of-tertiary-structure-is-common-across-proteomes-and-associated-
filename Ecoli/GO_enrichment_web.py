...
def load_rep_genes():
    ...
    rep_genes = np.loadtxt("DATA/rep_genes_pdb_chain.txt", dtype = str, usecols = 0).tolist()
...
def create_excel(rep_genes: list):
    ...
    wb = Workbook()
    wb["Sheet"].title = "Ecoli_molecular_function"

    wb.create_sheet("Ecoli_biological_process")
    wb.create_sheet("Ecoli_cellular_component")
