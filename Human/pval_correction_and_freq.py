...
def main_question_correction():
    ...
    for pval_files in os.listdir("DATA/human_mc_pvals_stochastic_full/"):
...
if __name__ == "__main__":
    ...
    ax0.set_title(label="Frequency Table for Human Non-Covalent Lassos (corrected at 0.05) without Knots",  y = 0.8)
    ...
    plt.savefig("final_human_corrected", bbox_inches = "tight")
