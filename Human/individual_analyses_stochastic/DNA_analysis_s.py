...
def null_dist_p_val_calc(uniprot: str):
    ...
    functional_info = np.load("../../../Mongo_code/human_V2_functional_PDB_DNA-binding.npz", allow_pickle = True)["arr_0"].tolist()
...
def main():
    ...
    functional_sites = ["PDB_DNA-binding"]
