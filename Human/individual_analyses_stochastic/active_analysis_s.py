...
def null_dist_p_val_calc(uniprot: str):
    ...
    functional_info = np.load("../../../Mongo_code/human_V2_functional_active site.npz", allow_pickle = True)["arr_0"].tolist()
...
def main():
    ...
    for func_site in functional_sites:
        ...
        if functional_info and entanglement_info:
            ...
            # these genes did not converge in analsyis 
