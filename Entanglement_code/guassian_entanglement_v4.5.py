...
def calculate_native_entanglements(pdb_file: str) -> None:
    ...
    ref_univ = mda.Universe(f"Before_TER_PDBs/{pdb_file}", format="PDB")
    ...
    for chain in chains_to_analyze:
        ...
        ref_allatoms_unique = mda.Merge(*[ref_allatoms_unique.select_atoms(f"resid {resid} or resid {resid}A") for resid in PDB_resids])
...
if __name__ == "__main__":
    ...
    input_data = os.listdir("Before_TER_PDBs/")
